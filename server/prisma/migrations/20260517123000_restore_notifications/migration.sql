-- Restore notifications after the settings migration dropped the table.
...
CREATE INDEX "notifications_userId_spaceId_read_idx" ON "notifications"("userId", "spaceId", "read");
